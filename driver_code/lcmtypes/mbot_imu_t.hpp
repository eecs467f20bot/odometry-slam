...
#ifndef __mbot_imu_t_hpp__
#define __mbot_imu_t_hpp__
...
int mbot_imu_t::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    ...
    tlen = __float_encode_array(buf, offset + pos, maxlen - pos, &this->tb_angles[0], 3);
    if(tlen < 0) return tlen; else pos += tlen;
...
int mbot_imu_t::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    ...
    tlen = __float_decode_array(buf, offset + pos, maxlen - pos, &this->tb_angles[0], 3);
    if(tlen < 0) return tlen; else pos += tlen;
